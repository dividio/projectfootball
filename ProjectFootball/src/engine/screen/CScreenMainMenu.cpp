...
CScreenMainMenu* CScreenMainMenu::getInstance()
{
  static CScreenMainMenu instance;
  return &instance;
}
...
void CScreenMainMenu::forcedLeave()
{

}


bool CScreenMainMenu::leave()
{
    return true;
}


void CScreenMainMenu::update()
{
}
