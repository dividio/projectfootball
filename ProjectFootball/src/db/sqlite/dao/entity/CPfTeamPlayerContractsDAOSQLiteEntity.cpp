...
CPfTeamPlayerContracts* CPfTeamPlayerContractsDAOSQLiteEntity::loadRegister(std::string sql)
{
    char *msgError = NULL;
...
std::vector<CPfTeamPlayerContracts*> * CPfTeamPlayerContractsDAOSQLiteEntity::loadVector(std::string sql)
{
    char *msgError = NULL;
...
bool CPfTeamPlayerContractsDAOSQLiteEntity::exec(std::string sql)
{
    char *msgError = NULL;
    bool correct = true;
