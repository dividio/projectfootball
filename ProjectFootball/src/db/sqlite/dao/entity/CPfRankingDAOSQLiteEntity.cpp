...
CPfRanking* CPfRankingDAOSQLiteEntity::loadRegister(std::string sql)
{
    char *msgError = NULL;
...
std::vector<CPfRanking*> * CPfRankingDAOSQLiteEntity::loadVector(std::string sql)
{
    char *msgError = NULL;
...
bool CPfRankingDAOSQLiteEntity::exec(std::string sql)
{
    char *msgError = NULL;
    bool correct = true;
