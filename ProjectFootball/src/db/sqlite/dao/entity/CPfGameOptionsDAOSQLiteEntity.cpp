...
bool CPfGameOptionsDAOSQLiteEntity::insertReg(CPfGameOptions *reg)
{
    ...
    sql = sql+" '"+reg->getSCategory_str()+"'";
    sql = sql+",'"+reg->getSValue_str()+"'";
    sql = sql+",'"+reg->getSAttribute_str()+"'";
    sql = sql+")";
    return exec(sql);
}
...
bool CPfGameOptionsDAOSQLiteEntity::updateReg(CPfGameOptions *reg)
{
    ...
    sql = sql+" S_CATEGORY='"+reg->getSCategory_str()+"'";
    sql = sql+",X_OPTION='"+reg->getXOption_str()+"'";
    sql = sql+",S_VALUE='"+reg->getSValue_str()+"'";
    sql = sql+",S_ATTRIBUTE='"+reg->getSAttribute_str()+"'";
    sql = sql+" WHERE X_OPTION='"+reg->getXOption_str()+"'";
    return exec(sql);
}
