...
bool CPfTeamPlayersDAOSQLiteEntity::deleteReg(CPfTeamPlayers *reg)
{
    ...
    sql = sql+"'"+reg->getXTeamPlayer_str()+"'";
    return exec(sql);
}
...
bool CPfTeamPlayersDAOSQLiteEntity::updateReg(CPfTeamPlayers *reg)
{
    ...
    sql = sql+" X_TEAM_PLAYER='"+reg->getXTeamPlayer_str()+"'";
    sql = sql+",S_NAME='"+reg->getSName_str()+"'";
    sql = sql+" WHERE X_TEAM_PLAYER='"+reg->getXTeamPlayer_str()+"'";
    return exec(sql);
}
    ...
    if( object!=NULL ){
        ...
        for( int i=0; i<nColumns; i++ ){
            if( strcmp(sColumn[i], "X_TEAM_PLAYER")==0 ){
                destiny->setXTeamPlayer_str(vColumn[i]);
