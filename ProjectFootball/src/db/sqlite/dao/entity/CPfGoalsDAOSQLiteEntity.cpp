...
CPfGoals* CPfGoalsDAOSQLiteEntity::loadRegister(std::string sql)
{
    char *msgError = NULL;
...
std::vector<CPfGoals*> * CPfGoalsDAOSQLiteEntity::loadVector(std::string sql)
{
    char *msgError = NULL;
...
bool CPfGoalsDAOSQLiteEntity::exec(std::string sql)
{
    char *msgError = NULL;
    bool correct = true;
