...
public:
    ...
    virtual IPfPaisesDAO* getIPfPaisesDAO();
    virtual IPfEquiposDAO* getIPfEquiposDAO();
...
private:
    ...
    CPfPaisesDAOSQLite *m_PfPaisesDAOSQLite;
    CPfEquiposDAOSQLite *m_PfEquiposDAOSQLite;
