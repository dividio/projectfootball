    ...
    (
      ...
      (
        SELECT X_MATCH,
          X_FK_TEAM_HOME,
          X_FK_TEAM_AWAY,
          (SELECT COUNT(X_GOAL) FROM PF_GOALS WHERE X_FK_TEAM_SCORER=X_FK_TEAM_HOME) AS HOME_GOALS,
          (SELECT COUNT(X_GOAL) FROM PF_GOALS WHERE X_FK_TEAM_SCORER=X_FK_TEAM_AWAY) AS AWAY_GOALS
        FROM PF_MATCHES
        WHERE L_PLAYED='Y'
      )
