...
CStateMatchResult::CStateMatchResult()
 :CState()
{
    CLog::getInstance()->debug("CStateMatchResult()");
...
CStateMatchResult* CStateMatchResult::getInstance()
{
    static CStateMatchResult instance;
    return &instance;
}

void CStateMatchResult::enter()
{
...
void CStateMatchResult::forcedLeave()
{

}

bool CStateMatchResult::leave()
{
...
void CStateMatchResult::update()
{

}

void CStateMatchResult::loadMatchInfo(CPfMatches *match)
{
    IDAOFactory             *daoFactory           = CGameEngine::getInstance()->getCurrentGame()->getIDAOFactory();
    IPfMatchesDAO           *matchesDAO           = daoFactory->getIPfMatchesDAO();
...
void CStateMatchResult::simulateMatches()
{
    IDAOFactory         *daoFactory = CGameEngine::getInstance()->getCurrentGame()->getIDAOFactory();
...
int CStateMatchResult::getRandomNGoals()
{
    int n = rand()%100;
