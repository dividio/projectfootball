...
#define SWIGTYPE_p_CEGUI__ActivationEventArgs swig_types[0]
#define SWIGTYPE_p_CEGUI__DragDropEventArgs swig_types[1]
#define SWIGTYPE_p_CEGUI__EventArgs swig_types[2]
#define SWIGTYPE_p_CEGUI__Key swig_types[3]
#define SWIGTYPE_p_CEGUI__KeyEventArgs swig_types[4]
#define SWIGTYPE_p_CEGUI__MouseCursorEventArgs swig_types[5]
#define SWIGTYPE_p_CEGUI__MouseEventArgs swig_types[6]
#define SWIGTYPE_p_CEGUI__WindowEventArgs swig_types[7]
#define SWIGTYPE_p_DragContainer swig_types[8]
#define SWIGTYPE_p_Image swig_types[9]
#define SWIGTYPE_p_MouseCursor swig_types[10]
#define SWIGTYPE_p_Point swig_types[11]
#define SWIGTYPE_p_Vector2 swig_types[12]
...
#define SWIGTYPE_p_std__pairT_float_float_t swig_types[17]
...
#define SWIGTYPE_p_utf32 swig_types[22]
...
#define SWIG_init      luaopen_CEGUI
#define SWIG_init_user luaopen_CEGUI_user

#define SWIG_LUACODE   luaopen_CEGUI_luacode
...
static int _wrap_DefaultNativeHorzRes_get(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::DefaultNativeHorzRes",0,0)
...
static int _wrap_DefaultNativeVertRes_get(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::DefaultNativeVertRes",0,0)
...
static int _wrap_new__FloatFloatPair__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("std::pair<(float,float)>",0,0)
  result = (std::pair< float,float > *)new std::pair< float,float >();
  SWIG_arg=0;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__pairT_float_float_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new__FloatFloatPair__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("std::pair<(float,float)>",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("std::pair<(float,float)>",1,"float");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::pair<(float,float)>",2,"float");
...
static int _wrap_new__FloatFloatPair__SWIG_2(lua_State* L) {
  ...
  SWIG_check_num_args("std::pair<(float,float)>",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::pair<(float,float)>",1,"std::pair< float,float > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__pairT_float_float_t,0))){
    SWIG_fail_ptr("new__FloatFloatPair",1,SWIGTYPE_p_std__pairT_float_float_t);
  }
...
static int _wrap_new__FloatFloatPair(lua_State* L) {
  ...
  if (argc == 1) {
    ...
    {
      void *ptr;
      if (lua_isuserdata(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_std__pairT_float_float_t, 0)) {
        _v = 0;
      } else {
        _v = 1;
      }
...
static int _wrap__FloatFloatPair_first_set(lua_State* L) {
  ...
  SWIG_check_num_args("first",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("first",1,"std::pair< float,float > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("first",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__pairT_float_float_t,0))){
    SWIG_fail_ptr("_FloatFloatPair_first_set",1,SWIGTYPE_p_std__pairT_float_float_t);
  }
...
static int _wrap__FloatFloatPair_first_get(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__pairT_float_float_t,0))){
    SWIG_fail_ptr("_FloatFloatPair_first_get",1,SWIGTYPE_p_std__pairT_float_float_t);
  }
...
static int _wrap__FloatFloatPair_second_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("second",1,"std::pair< float,float > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("second",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__pairT_float_float_t,0))){
    SWIG_fail_ptr("_FloatFloatPair_second_set",1,SWIGTYPE_p_std__pairT_float_float_t);
  }
...
static int _wrap__FloatFloatPair_second_get(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__pairT_float_float_t,0))){
    SWIG_fail_ptr("_FloatFloatPair_second_get",1,SWIGTYPE_p_std__pairT_float_float_t);
  }
...
static int _wrap_delete__FloatFloatPair(lua_State* L) {
  ...
  SWIG_check_num_args("std::pair<(float,float)>::~pair<(float,float)>",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::pair<(float,float)>::~pair<(float,float)>",1,"std::pair< float,float > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__pairT_float_float_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("delete__FloatFloatPair",1,SWIGTYPE_p_std__pairT_float_float_t);
  }
...
static const char *swig_std_pair_Sl_float_Sc_float_Sg__base_names[] = {0};
static swig_lua_class _wrap_class_std_pair_Sl_float_Sc_float_Sg_ = { "_FloatFloatPair", &SWIGTYPE_p_std__pairT_float_float_t,_wrap_new__FloatFloatPair, swig_delete__FloatFloatPair, swig_std_pair_Sl_float_Sc_float_Sg__methods, swig_std_pair_Sl_float_Sc_float_Sg__attributes, swig_std_pair_Sl_float_Sc_float_Sg__bases, swig_std_pair_Sl_float_Sc_float_Sg__base_names };

static int _wrap_new_EventArgs(lua_State* L) {
  int SWIG_arg = -1;
  CEGUI::EventArgs *result = 0 ;
  
  SWIG_check_num_args("CEGUI::EventArgs",0,0)
...
static int _wrap_delete_EventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::~EventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::~EventArgs",1,"CEGUI::EventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__EventArgs,SWIG_POINTER_DISOWN))){
...
static int _wrap_EventArgs_Handled_set(lua_State* L) {
  ...
  SWIG_check_num_args("handled",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("handled",1,"CEGUI::EventArgs *");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("handled",2,"bool");
...
static int _wrap_EventArgs_Handled_get(lua_State* L) {
  ...
  SWIG_check_num_args("handled",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("handled",1,"CEGUI::EventArgs *");
...
static const char *swig_CEGUI_EventArgs_base_names[] = {0};
static swig_lua_class _wrap_class_CEGUI_EventArgs = { "EventArgs", &SWIGTYPE_p_CEGUI__EventArgs,_wrap_new_EventArgs, swig_delete_EventArgs, swig_CEGUI_EventArgs_methods, swig_CEGUI_EventArgs_attributes, swig_CEGUI_EventArgs_bases, swig_CEGUI_EventArgs_base_names };

static int _wrap_new_Key(lua_State* L) {
  int SWIG_arg = -1;
  CEGUI::Key *result = 0 ;
  
  SWIG_check_num_args("CEGUI::Key::Key",0,0)
...
static int _wrap_delete_Key(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::Key::~Key",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::Key::~Key",1,"CEGUI::Key *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__Key,SWIG_POINTER_DISOWN))){
...
static const char *swig_CEGUI_Key_base_names[] = {0};
static swig_lua_class _wrap_class_CEGUI_Key = { "Key", &SWIGTYPE_p_CEGUI__Key,_wrap_new_Key, swig_delete_Key, swig_CEGUI_Key_methods, swig_CEGUI_Key_attributes, swig_CEGUI_Key_bases, swig_CEGUI_Key_base_names };
...
static int _wrap_new_WindowEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::WindowEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::WindowEventArgs",1,"Window *");
...
static int _wrap_WindowEventArgs_Window_set(lua_State* L) {
  ...
  SWIG_check_num_args("window",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("window",1,"CEGUI::WindowEventArgs *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("window",2,"Window *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_Window,SWIG_POINTER_DISOWN))){
...
static int _wrap_WindowEventArgs_Window_get(lua_State* L) {
  ...
  SWIG_check_num_args("window",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("window",1,"CEGUI::WindowEventArgs *");
...
static int _wrap_delete_WindowEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::WindowEventArgs::~WindowEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::WindowEventArgs::~WindowEventArgs",1,"CEGUI::WindowEventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__WindowEventArgs,SWIG_POINTER_DISOWN))){
...
static swig_lua_class *swig_CEGUI_WindowEventArgs_bases[] = {0,0};
static const char *swig_CEGUI_WindowEventArgs_base_names[] = {"CEGUI::EventArgs *",0};
static swig_lua_class _wrap_class_CEGUI_WindowEventArgs = { "WindowEventArgs", &SWIGTYPE_p_CEGUI__WindowEventArgs,_wrap_new_WindowEventArgs, swig_delete_WindowEventArgs, swig_CEGUI_WindowEventArgs_methods, swig_CEGUI_WindowEventArgs_attributes, swig_CEGUI_WindowEventArgs_bases, swig_CEGUI_WindowEventArgs_base_names };
...
static int _wrap_new_MouseEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::MouseEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::MouseEventArgs",1,"Window *");
...
static int _wrap_MouseEventArgs_Position_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("position",1,"CEGUI::MouseEventArgs *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("position",2,"Point");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_Point,0))){
    SWIG_fail_ptr("MouseEventArgs_Position_set",2,SWIGTYPE_p_Point);
  }
  arg2 = *argp2;
...
static int _wrap_MouseEventArgs_MoveDelta_set(lua_State* L) {
  ...
  SWIG_check_num_args("moveDelta",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("moveDelta",1,"CEGUI::MouseEventArgs *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("moveDelta",2,"Vector2");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_Vector2,0))){
    SWIG_fail_ptr("MouseEventArgs_MoveDelta_set",2,SWIGTYPE_p_Vector2);
  }
  arg2 = *argp2;
...
static int _wrap_MouseEventArgs_MoveDelta_get(lua_State* L) {
  ...
  SWIG_check_num_args("moveDelta",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("moveDelta",1,"CEGUI::MouseEventArgs *");
...
static int _wrap_MouseEventArgs_Button_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("button",1,"CEGUI::MouseEventArgs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("button",2,"CEGUI::MouseButton");
...
static int _wrap_MouseEventArgs_SysKeys_set(lua_State* L) {
  ...
  SWIG_check_num_args("sysKeys",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sysKeys",1,"CEGUI::MouseEventArgs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("sysKeys",2,"CEGUI::uint");
...
static int _wrap_MouseEventArgs_SysKeys_get(lua_State* L) {
  ...
  SWIG_check_num_args("sysKeys",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sysKeys",1,"CEGUI::MouseEventArgs *");
...
static int _wrap_MouseEventArgs_WheelChange_set(lua_State* L) {
  ...
  SWIG_check_num_args("wheelChange",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("wheelChange",1,"CEGUI::MouseEventArgs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("wheelChange",2,"float");
...
static int _wrap_MouseEventArgs_WheelChange_get(lua_State* L) {
  ...
  SWIG_check_num_args("wheelChange",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("wheelChange",1,"CEGUI::MouseEventArgs *");
...
static int _wrap_MouseEventArgs_ClickCount_set(lua_State* L) {
  ...
  SWIG_check_num_args("clickCount",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("clickCount",1,"CEGUI::MouseEventArgs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("clickCount",2,"CEGUI::uint");
...
static int _wrap_MouseEventArgs_ClickCount_get(lua_State* L) {
  ...
  SWIG_check_num_args("clickCount",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("clickCount",1,"CEGUI::MouseEventArgs *");
...
static int _wrap_delete_MouseEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::MouseEventArgs::~MouseEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::MouseEventArgs::~MouseEventArgs",1,"CEGUI::MouseEventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__MouseEventArgs,SWIG_POINTER_DISOWN))){
...
static swig_lua_class *swig_CEGUI_MouseEventArgs_bases[] = {0,0};
static const char *swig_CEGUI_MouseEventArgs_base_names[] = {"CEGUI::WindowEventArgs *",0};
static swig_lua_class _wrap_class_CEGUI_MouseEventArgs = { "MouseEventArgs", &SWIGTYPE_p_CEGUI__MouseEventArgs,_wrap_new_MouseEventArgs, swig_delete_MouseEventArgs, swig_CEGUI_MouseEventArgs_methods, swig_CEGUI_MouseEventArgs_attributes, swig_CEGUI_MouseEventArgs_bases, swig_CEGUI_MouseEventArgs_base_names };
...
static int _wrap_new_MouseCursorEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::MouseCursorEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::MouseCursorEventArgs",1,"MouseCursor *");
...
static int _wrap_MouseCursorEventArgs_MouseCursor_set(lua_State* L) {
  ...
  SWIG_check_num_args("mouseCursor",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("mouseCursor",1,"CEGUI::MouseCursorEventArgs *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("mouseCursor",2,"MouseCursor *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_MouseCursor,SWIG_POINTER_DISOWN))){
...
static int _wrap_MouseCursorEventArgs_MouseCursor_get(lua_State* L) {
  ...
  SWIG_check_num_args("mouseCursor",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("mouseCursor",1,"CEGUI::MouseCursorEventArgs *");
...
static int _wrap_MouseCursorEventArgs_Image_set(lua_State* L) {
  ...
  SWIG_check_num_args("image",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("image",1,"CEGUI::MouseCursorEventArgs *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("image",2,"Image const *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_Image,SWIG_POINTER_DISOWN))){
...
static int _wrap_delete_MouseCursorEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::MouseCursorEventArgs::~MouseCursorEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::MouseCursorEventArgs::~MouseCursorEventArgs",1,"CEGUI::MouseCursorEventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__MouseCursorEventArgs,SWIG_POINTER_DISOWN))){
...
static swig_lua_class *swig_CEGUI_MouseCursorEventArgs_bases[] = {0,0};
static const char *swig_CEGUI_MouseCursorEventArgs_base_names[] = {"CEGUI::EventArgs *",0};
static swig_lua_class _wrap_class_CEGUI_MouseCursorEventArgs = { "MouseCursorEventArgs", &SWIGTYPE_p_CEGUI__MouseCursorEventArgs,_wrap_new_MouseCursorEventArgs, swig_delete_MouseCursorEventArgs, swig_CEGUI_MouseCursorEventArgs_methods, swig_CEGUI_MouseCursorEventArgs_attributes, swig_CEGUI_MouseCursorEventArgs_bases, swig_CEGUI_MouseCursorEventArgs_base_names };
...
static int _wrap_new_KeyEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::KeyEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::KeyEventArgs",1,"Window *");
...
static int _wrap_KeyEventArgs_Codepoint_set(lua_State* L) {
  ...
  SWIG_check_num_args("codepoint",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("codepoint",1,"CEGUI::KeyEventArgs *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("codepoint",2,"utf32");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_utf32,0))){
    SWIG_fail_ptr("KeyEventArgs_Codepoint_set",2,SWIGTYPE_p_utf32);
  }
  arg2 = *argp2;
...
static int _wrap_KeyEventArgs_Codepoint_get(lua_State* L) {
  ...
  SWIG_check_num_args("codepoint",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("codepoint",1,"CEGUI::KeyEventArgs *");
...
static int _wrap_KeyEventArgs_Scancode_set(lua_State* L) {
  ...
  SWIG_check_num_args("scancode",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("scancode",1,"CEGUI::KeyEventArgs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("scancode",2,"CEGUI::Key::Scan");
...
static int _wrap_KeyEventArgs_Scancode_get(lua_State* L) {
  ...
  SWIG_check_num_args("scancode",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("scancode",1,"CEGUI::KeyEventArgs *");
...
static int _wrap_KeyEventArgs_SysKeys_set(lua_State* L) {
  ...
  SWIG_check_num_args("sysKeys",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("sysKeys",1,"CEGUI::KeyEventArgs *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("sysKeys",2,"CEGUI::uint");
...
static int _wrap_delete_KeyEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::KeyEventArgs::~KeyEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::KeyEventArgs::~KeyEventArgs",1,"CEGUI::KeyEventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__KeyEventArgs,SWIG_POINTER_DISOWN))){
...
static swig_lua_class *swig_CEGUI_KeyEventArgs_bases[] = {0,0};
static const char *swig_CEGUI_KeyEventArgs_base_names[] = {"CEGUI::WindowEventArgs *",0};
static swig_lua_class _wrap_class_CEGUI_KeyEventArgs = { "KeyEventArgs", &SWIGTYPE_p_CEGUI__KeyEventArgs,_wrap_new_KeyEventArgs, swig_delete_KeyEventArgs, swig_CEGUI_KeyEventArgs_methods, swig_CEGUI_KeyEventArgs_attributes, swig_CEGUI_KeyEventArgs_bases, swig_CEGUI_KeyEventArgs_base_names };
...
static int _wrap_new_ActivationEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::ActivationEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::ActivationEventArgs",1,"Window *");
...
static int _wrap_ActivationEventArgs_OtherWindow_set(lua_State* L) {
  ...
  SWIG_check_num_args("otherWindow",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("otherWindow",1,"CEGUI::ActivationEventArgs *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("otherWindow",2,"Window *");
...
static int _wrap_ActivationEventArgs_OtherWindow_get(lua_State* L) {
  ...
  SWIG_check_num_args("otherWindow",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("otherWindow",1,"CEGUI::ActivationEventArgs *");
...
static int _wrap_delete_ActivationEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::ActivationEventArgs::~ActivationEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::ActivationEventArgs::~ActivationEventArgs",1,"CEGUI::ActivationEventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__ActivationEventArgs,SWIG_POINTER_DISOWN))){
...
static swig_lua_class *swig_CEGUI_ActivationEventArgs_bases[] = {0,0};
static const char *swig_CEGUI_ActivationEventArgs_base_names[] = {"CEGUI::WindowEventArgs *",0};
static swig_lua_class _wrap_class_CEGUI_ActivationEventArgs = { "ActivationEventArgs", &SWIGTYPE_p_CEGUI__ActivationEventArgs,_wrap_new_ActivationEventArgs, swig_delete_ActivationEventArgs, swig_CEGUI_ActivationEventArgs_methods, swig_CEGUI_ActivationEventArgs_attributes, swig_CEGUI_ActivationEventArgs_bases, swig_CEGUI_ActivationEventArgs_base_names };
...
static int _wrap_new_DragDropEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::DragDropEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::DragDropEventArgs",1,"Window *");
...
static int _wrap_DragDropEventArgs_DragDropItem_set(lua_State* L) {
  ...
  SWIG_check_num_args("dragDropItem",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("dragDropItem",1,"CEGUI::DragDropEventArgs *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("dragDropItem",2,"DragContainer *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_DragContainer,SWIG_POINTER_DISOWN))){
...
static int _wrap_DragDropEventArgs_DragDropItem_get(lua_State* L) {
  ...
  SWIG_check_num_args("dragDropItem",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("dragDropItem",1,"CEGUI::DragDropEventArgs *");
...
static int _wrap_delete_DragDropEventArgs(lua_State* L) {
  ...
  SWIG_check_num_args("CEGUI::DragDropEventArgs::~DragDropEventArgs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEGUI::DragDropEventArgs::~DragDropEventArgs",1,"CEGUI::DragDropEventArgs *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEGUI__DragDropEventArgs,SWIG_POINTER_DISOWN))){
...
static swig_lua_class *swig_CEGUI_DragDropEventArgs_bases[] = {0,0};
static const char *swig_CEGUI_DragDropEventArgs_base_names[] = {"CEGUI::WindowEventArgs *",0};
static swig_lua_class _wrap_class_CEGUI_DragDropEventArgs = { "DragDropEventArgs", &SWIGTYPE_p_CEGUI__DragDropEventArgs,_wrap_new_DragDropEventArgs, swig_delete_DragDropEventArgs, swig_CEGUI_DragDropEventArgs_methods, swig_CEGUI_DragDropEventArgs_attributes, swig_CEGUI_DragDropEventArgs_bases, swig_CEGUI_DragDropEventArgs_base_names };
...
static swig_lua_var_info swig_variables[] = {
    { "DefaultNativeHorzRes", _wrap_DefaultNativeHorzRes_get, SWIG_Lua_set_immutable },
    { "DefaultNativeVertRes", _wrap_DefaultNativeVertRes_get, SWIG_Lua_set_immutable },
    {0,0,0}
};
...
static void *_p_CEGUI__MouseEventArgsTo_p_CEGUI__WindowEventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::WindowEventArgs *)  ((CEGUI::MouseEventArgs *) x));
}
static void *_p_CEGUI__KeyEventArgsTo_p_CEGUI__WindowEventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::WindowEventArgs *)  ((CEGUI::KeyEventArgs *) x));
}
static void *_p_CEGUI__ActivationEventArgsTo_p_CEGUI__WindowEventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::WindowEventArgs *)  ((CEGUI::ActivationEventArgs *) x));
}
static void *_p_CEGUI__DragDropEventArgsTo_p_CEGUI__WindowEventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::WindowEventArgs *)  ((CEGUI::DragDropEventArgs *) x));
}
static void *_p_CEGUI__WindowEventArgsTo_p_CEGUI__EventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::EventArgs *)  ((CEGUI::WindowEventArgs *) x));
}
static void *_p_CEGUI__MouseEventArgsTo_p_CEGUI__EventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::EventArgs *) (CEGUI::WindowEventArgs *) ((CEGUI::MouseEventArgs *) x));
}
static void *_p_CEGUI__MouseCursorEventArgsTo_p_CEGUI__EventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::EventArgs *)  ((CEGUI::MouseCursorEventArgs *) x));
}
static void *_p_CEGUI__KeyEventArgsTo_p_CEGUI__EventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::EventArgs *) (CEGUI::WindowEventArgs *) ((CEGUI::KeyEventArgs *) x));
}
static void *_p_CEGUI__ActivationEventArgsTo_p_CEGUI__EventArgs(void *x, int *newmemory) {
    return (void *)((CEGUI::EventArgs *) (CEGUI::WindowEventArgs *) ((CEGUI::ActivationEventArgs *) x));
}
static void *_p_CEGUI__DragDropEventArgsTo_p_CEGUI__EventArgs(void *x, int *newmemory) {
...
static swig_type_info _swigt__p_std__pairT_float_float_t = {"_p_std__pairT_float_float_t", "std::pair< float,float > *", 0, 0, (void*)&_wrap_class_std_pair_Sl_float_Sc_float_Sg_, 0};
static swig_type_info _swigt__p_unsigned_char = {"_p_unsigned_char", "CEGUI::uchar *|unsigned char *|CEGUI::uint8 *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_int = {"_p_unsigned_int", "CEGUI::uint32 *|unsigned int *|CEGUI::uint *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_long = {"_p_unsigned_long", "CEGUI::ulong *|unsigned long *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_short = {"_p_unsigned_short", "CEGUI::uint16 *|unsigned short *|CEGUI::ushort *", 0, 0, (void*)0, 0};
