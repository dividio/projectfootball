...
public:
    ...
    virtual std::vector<CPfTeamPlayerContracts*>* findByXFkTeam(int XFkTeam, const std::string &timestamp) =0;
    virtual std::vector<CPfTeamPlayerContracts*>* findByXFkTeam(const std::string &XFkTeam, const std::string &timestamp) =0;
