...
CREATE INDEX PF_TEAM_PLAYER_AVERAGES_X_TEAM_PLAYER ON PF_TEAM_PLAYER_AVERAGES (X_TEAM_PLAYER);
...
CREATE INDEX PF_REGISTERED_TEAMS_X_REGISTERED_TEAM ON PF_REGISTERED_TEAMS (X_REGISTERED_TEAM);
CREATE INDEX PF_REGISTERED_TEAMS_X_FK_COMPETITION ON PF_REGISTERED_TEAMS (X_FK_COMPETITION);
CREATE INDEX PF_REGISTERED_TEAMS_X_FK_TEAM ON PF_REGISTERED_TEAMS (X_FK_TEAM);
...
CREATE INDEX PF_TEAM_AVERAGES_X_TEAM ON PF_TEAM_AVERAGES (X_TEAM);
