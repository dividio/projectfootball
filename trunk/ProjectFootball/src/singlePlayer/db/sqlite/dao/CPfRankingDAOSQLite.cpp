           ...
           "( "
             ...
             "( "
               ...
               "( "
                 ...
                 "FROM PF_MATCHES "
                 "JOIN PF_PHASE_ROUNDS ON X_PHASE_ROUND = X_FK_PHASE_ROUND "
                 "JOIN PF_COMPETITION_PHASES ON X_FK_COMPETITION_PHASE = X_COMPETITION_PHASE AND X_FK_COMPETITION = " + competition.str() + " "
