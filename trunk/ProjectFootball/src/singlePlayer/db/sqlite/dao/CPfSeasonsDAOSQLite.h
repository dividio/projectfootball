...
#ifndef CPFSEASONSDAOSQLITE_H_
#define CPFSEASONSDAOSQLITE_H_

#include <string>
#include <sqlite3.h>

#include "entity/CPfSeasonsDAOSQLiteEntity.h"
#include "../../bean/CPfSeasons.h"

class CPfSeasonsDAOSQLite : public CPfSeasonsDAOSQLiteEntity
{
public:
    CPfSeasonsDAOSQLite(sqlite3 *database);
    virtual ~CPfSeasonsDAOSQLite();
