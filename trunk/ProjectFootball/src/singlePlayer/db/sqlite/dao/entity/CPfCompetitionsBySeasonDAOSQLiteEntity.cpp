...
{
    if( m_database==NULL ){
        CLog::getInstance()->exception("[CPfCompetitionsBySeasonDAOSQLiteEntity::loadRegister] No database connection.");
    }
...
{
    if( m_database==NULL ){
        CLog::getInstance()->exception("[CPfCompetitionsBySeasonDAOSQLiteEntity::loadVector] No database connection.");
    }
...
{
    if( m_database==NULL ){
        CLog::getInstance()->exception("[CPfCompetitionsBySeasonDAOSQLiteEntity::exec] No database connection.");
    }
