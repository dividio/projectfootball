...
{
    if( m_database==NULL ){
        CLog::getInstance()->exception("[CPfSeasonsDAOSQLiteEntity::loadRegister] No database connection.");
    }
...
{
    if( m_database==NULL ){
        CLog::getInstance()->exception("[CPfSeasonsDAOSQLiteEntity::loadVector] No database connection.");
    }
...
{
    if( m_database==NULL ){
        CLog::getInstance()->exception("[CPfSeasonsDAOSQLiteEntity::exec] No database connection.");
    }
