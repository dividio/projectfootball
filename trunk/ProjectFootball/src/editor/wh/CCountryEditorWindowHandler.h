...
#ifndef CCOUNTRYEDITORWINDOWHANDLER_H_
#define CCOUNTRYEDITORWINDOWHANDLER_H_
...
class CCountryEditorWindowHandler : public CWindowHandler
{
	public:
		CCountryEditorWindowHandler(CGameEditor &editor);
		virtual ~CCountryEditorWindowHandler();
	...
	private:
		void populateEntry(std::vector< CPfCountries * >::iterator it, std::string *label, unsigned int *id);
...
#endif /*CCOUNTRYEDITORWINDOWHANDLER_H_*/
